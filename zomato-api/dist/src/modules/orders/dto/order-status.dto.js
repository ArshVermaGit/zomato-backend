...
exports.AssignDeliveryPartnerDto = exports.CancelOrderDto = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Customer called to cancel' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'partner-uuid' }),
    (0, class_validator_1.IsNotEmpty)(),
