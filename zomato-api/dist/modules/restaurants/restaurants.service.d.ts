...
export declare class RestaurantsService {
    ...
    constructor(prisma: PrismaService, realtimeGateway: RealtimeGateway, s3Service: S3Service, geocodingService: GeocodingService);
    ...
    getAnalytics(restaurantId: string, range: string): unknown;
}
