...
export class UsersService {
  ...
  async getProfile(userId: string) {
    ...
    // @ts-expect-error: password is a valid field in the database but might be omitted in the model type or prisma results
  ...
  getAvatarUploadUrl(userId: string) {
    const _key = `avatars/${userId}-${Date.now()}.jpeg`;
