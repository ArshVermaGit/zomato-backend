...
export class PromosController {
  ...
  async validatePromo(
    @Request() req,
    @Body() body: { code: string; cartValue: number; restaurantId: string },
  ) {
    return this.promosService.validatePromoCode(
      body.code,
      req.user.userId,
      body.cartValue,
      body.restaurantId,
  ...
  async applyPromo(
    ...
    return this.promosService.applyPromo(
      body.code,
      req.user.userId,
      body.cartValue,
      body.restaurantId,
  ...
  async getBestPromo(
    ...
    return this.promosService.getBestPromo(
      req.user.userId,
