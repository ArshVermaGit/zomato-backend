...
export class MenuController {
    ...
    async updateCategory(@Request() req, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateCategoryDto) {
    ...
    async reorderCategory(@Request() req, @Param('id', ParseUUIDPipe) id: string, @Body() dto: ReorderCategoryDto) {
    ...
    async updateItem(@Request() req, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateMenuItemDto) {
    ...
    async toggleAvailability(@Request() req, @Param('id', ParseUUIDPipe) id: string) {
    ...
    async addImage(@Request() req, @Param('id', ParseUUIDPipe) id: string, @Body('imageUrl') imageUrl: string) {
    ...
    async updateModifier(@Request() req, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateModifierDto) {
