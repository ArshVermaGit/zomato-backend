...
export class MapsController {
    ...
    async getDistance(@Body() body: { origin: { lat: number, lng: number }, destination: { lat: number, lng: number } }) {
    ...
    async getETA(@Body() body: { origin: { lat: number, lng: number }, destination: { lat: number, lng: number } }) {
    ...
    async getNearbyRestaurants(@Query('lat') lat: number, @Query('lng') lng: number, @Query('radius') radius: number) {
